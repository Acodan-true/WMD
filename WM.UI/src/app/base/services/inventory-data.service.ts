...
export class InventoryDataService {
    ...
    getInventory(filter: InventoryFilter) {
        return this.http.post<InventoryItem[]>("https://localhost:7079/api/inventories/get", {
    ...
    getFilterOptions() {
        return this.http.get<InventoryFilterOptions>("https://localhost:7079/api/inventories/filterOptions");
    }

    createItem(inventory: Inventory) {
        return this.http.post("https://localhost:7079/api/inventories/create", {
            id: inventory.id,
    ...
    deleteItem(id: number) {
        return this.http.delete(`https://localhost:7079/api/inventories/${id}`);
    }
}